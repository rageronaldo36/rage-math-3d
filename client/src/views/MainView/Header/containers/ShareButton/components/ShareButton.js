      ...
      <SharePopoverContainer>
        ...
        <CopyContainer>
          <CopyToClipboard text={url} onCopy={this.onCopy}>
            <Button type="primary" style={copyButtonStyle}>
              Copy
            </Button>
          </CopyToClipboard>
          <CopyStatus isVisible={this.state.isCopied}>Copied!</CopyStatus>
        </CopyContainer>
        {process.env.NODE_ENV === "development" && (
  ...
  render() {
    return (
      <PopModal
        ...
        source={
          <span onPointerDown={this.saveCameraData} onClick={this.saveGraph}>
